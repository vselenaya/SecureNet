...
#define SERVER_PORT 9091  // номер порта, где работает сервер
#define CERT_FILE "mim_cert.pem"  // файл с самоподписанным сертификатом сервера (который подсовываем для проверки)
